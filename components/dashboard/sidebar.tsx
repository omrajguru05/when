    ...
    <aside className="hidden w-[240px] shrink-0 border-r border-slate-200 bg-white lg:flex lg:flex-col">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? 'bg-accent-light text-accent-dark' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900',
              )}
            >
              <span className={cn(active ? 'text-accent-primary' : 'text-slate-400')}>{item.icon}</span>
              {item.label}
            </Link>
          );
        })}
      ...
      <div className="border-t border-slate-100 p-3">
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center justify-between rounded-md px-3 py-2 text-xs font-medium text-slate-500 hover:bg-slate-50 hover:text-slate-900"
        >
